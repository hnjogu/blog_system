...
{{--             <button
    ...
    <section id="learn" class="p-5">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-md">
            <img src="{{ asset('img/fundamentals.svg') }}" class="img-fluid" alt="" />
          </div>
    ...
    <section id="learn" class="p-5 bg-dark text-light">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-md">
            <img src="{{ asset('img/react.svg') }}" class="img-fluid" alt="" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="questions" class="p-5">
      <div class="container">
        <h2 class="text-center mb-4">Latest Blogs Highlights</h2>
